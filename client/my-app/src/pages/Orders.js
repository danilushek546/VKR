...
import ItemOrderingAdmin from "../components/ItemOrderingAdmin";
                ...
                <Col xs={12} className="mt-3 d-flex justify-content-center align-items-center">
                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Menu>
                            ...
                            {filter === "Завершенные" ? <Dropdown.Item disabled>Завершенные</Dropdown.Item> : <Dropdown.Item onClick={() => setFilter("Завершенные")}>Завершенные</Dropdown.Item>}
                            {filter === "Не завершенные" ? <Dropdown.Item disabled>Не завершенные</Dropdown.Item> : <Dropdown.Item onClick={() => setFilter("Не завершенные")}>Не завершенные</Dropdown.Item>}
                        </Dropdown.Menu>
                    </Dropdown>
                </Col>
            </Row>
