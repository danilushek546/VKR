    ...
    return (
        <Card key={device.id} style={{width: "100%"}} className="mb-3">
            <Card.Body>
                <Row>
                    <Col xs={4}>
                        <Image src={process.env.REACT_APP_API_URL + device.image} style={{width: "100%", maxWidth: 150, objectFit:"contain"}} />
                    </Col>
                    <Col xs={4}>
                        <Row>
                            <Col xs={12}>
                    ...
                    <Col xs={4}>
                        <Row>
                            <Col xs={12} className="d-flex justify-content-center">
                                {user.isAuth ? <Button variant="outline-dark" onClick={() => basket.setDeleteItemBasket(device, true)}>Убрать из корзины</Button>
                                    : <Button variant="outline-dark" onClick={() => basket.setDeleteItemBasket(device)}>Убрать из корзины</Button>
                                }
                            </Col>
                        </Row>
                        <Row className="mt-5">
